...
-   Load and compile delphinID classifications of PAMGuard detections.

-   Retrain a delphinID classifier on new prediction labels.

-   Apply a saved classifier to predict new data.
...
```{r}
selectDB <- 'pamguard/dcl0206.sqlite3' #🟩
...
dateRange <- NULL #🟩
export <- TRUE #🟩
append_to_file <- 'groupClassifications-0906251608'
verbose <- FALSE #🟩
...
## 🚀 Train a new delphinID classifier
...
```{r}
filename <- 'groupClassifications-0906251608' #🟩
targetVar <- 'label' #🟩
groupVar <- 'eventID' #🟩
minClicks <- 0 #🟩
minWhistles <- 0 #🟩
